...
_Pesan dikirim otomatis via Landing Page_`;
  ...
  // CLEAN CODE & ANTI-AUTOFILL GLITCH (LAPTOP/HP)
  // Memaksa browser (Chrome, Safari, iOS, Android) menggunakan warna tema gelap konstan meskipun menggunakan fitur isi otomatis
  const inputStyle = `
    w-full rounded-xl border border-slate-900 bg-slate-950 px-4 py-2.5 text-xs text-slate-300 placeholder-slate-700 font-medium transition-all shadow-inner

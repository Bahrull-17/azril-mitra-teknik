...
export default function Portfolio() {
  ...
  return (
    <section id="portfolio" className="relative bg-slate-950 pt-12 pb-10 px-4 sm:px-6 lg:px-8 overflow-x-hidden border-b border-slate-900/60 z-10">
      <div className="absolute top-1/2 left-10 w-72 h-72 bg-indigo-500/5 rounded-full blur-2xl pointer-events-none" />
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        ...
        <div className="flex w-full items-center gap-2 overflow-x-auto pb-3 mb-8 snap-x snap-mandatory scroll-smooth sm:flex-wrap sm:justify-center sm:px-0 sm:pb-0">
          {CATEGORIES.map((cat) => {
          ...
          <div className="relative w-full max-w-sm rounded-2xl border border-slate-800 bg-slate-900 p-5 shadow-2xl my-auto">
            ...
            <div className="flex items-center justify-between mb-3 pb-2 border-b border-slate-800/60">
              ...
              <button
                ...
                className="text-slate-400 hover:text-white p-1.5 rounded-xl bg-slate-950 border border-slate-800 hover:border-slate-700 transition-all cursor-pointer flex items-center justify-center shadow-md"
            ...
            {/* Judul Utama */}
            <div className="mb-4">
              <h3 className="text-base font-black text-white leading-tight">{selectedProject.title}</h3>
            </div>

            {/* Image Preview */}
            <div className="relative aspect-video w-full overflow-hidden rounded-xl bg-slate-950 border border-slate-800 mb-4">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="text-[10px] font-bold uppercase tracking-wider text-rose-400 mb-1">Masalah di Lapangan (Problem)</h4>
                <p className="text-xs text-slate-300 leading-relaxed">{selectedProject.details.problem}</p>
              </div>

              <div className="border-t border-slate-800 pt-3.5">
                <h4 className="text-[10px] font-bold uppercase tracking-wider text-emerald-400 mb-1">Langkah Penanganan (Solution)</h4>
                <p className="text-xs text-slate-300 leading-relaxed">{selectedProject.details.solution}</p>
              </div>

              <div className="border-t border-slate-800 pt-3.5">
                <h4 className="text-[10px] font-bold uppercase tracking-wider text-indigo-400 mb-2">Spesifikasi & Hasil Teknis</h4>
            ...
            <div className="mt-6 pt-4 border-t border-slate-800 flex justify-end">
              <button type="button" onClick={() => setSelectedProject(null)} className="w-full px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-xl shadow-md transition-all cursor-pointer active:scale-95">
                Selesai Membaca
              </button>
            </div>
          </div>
